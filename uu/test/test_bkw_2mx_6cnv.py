...
class Net(nn.Module):
    def __init__(self):
        ...
        self.block1 = sequential.mSequential(*[self.conv2d_1, self.conv2d_2, self.conv2d_3, self.mxp1, \
                                                self.conv2d_4, self.conv2d_5, self.conv2d_6, self.mxp2]) #
...
def main():
    ...
    model_ref =  Net_ref(w1, w2, w3, w4, w5, w6).to(device)
