...
class Net(nn.Module):
    ...
    def forward(self, x, H, W, Th, Tw):
        ...
        input_tile = padding_calc.get_input_tile(info, x, 1)
       # print(input_tile.size())
       # print(input_tile)
        out = self.conv2d_1(input_tile, info)
        out_1 = self.conv2d_2(out, info)
        #print("*******", out_1)
