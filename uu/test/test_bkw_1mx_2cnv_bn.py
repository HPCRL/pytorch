...
from uu.layers import maxpool2d, conv2d, sequential, tilesplit, tilecopy, batchnorm2d
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.bn = batchnorm2d.cBatchNorm2d(chanel)
      

        self.tsplit = tilesplit.TiledSplit()
        self.tcopy = tilecopy.TiledCopy()
        self.block1 = sequential.mSequential(*[self.conv2d_1, self.conv2d_2, self.bn, self.mxp1]) #, self.conv2d_3, self.conv2d_4,self.mxp2
